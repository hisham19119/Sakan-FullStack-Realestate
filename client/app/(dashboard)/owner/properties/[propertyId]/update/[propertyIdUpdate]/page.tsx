...
const updateProprtyPage = () => {
  ...
  let { data: property } = useProperty(id);
  property = property?.data?.property;
  console.log(
    "this is the property:",
    property ?? "Property data is loading..."
  );
  ...
  useEffect(() => {
    if (property) {
      form.reset({
        ...
        location: property.location?.location, // Ensure it's the ID for Select component
        ...
        type: property.type?.type, // Ensure it's the ID for Select component
      });
    }
  }, [property, form]);
  ...
  // if (loadingLocations) return <p>Loading locations...</p>;
  // const handleEditToggle = (field) => {
  //   // Your existing toggle logic
  // };

  const handleSubmit = async (data: any) => {
    await updateProperty({ id, data }); // Pass the ID and data
  };
...
export default updateProprtyPage;
